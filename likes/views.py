...
class LikeList(generics.ListCreateAPIView):
    ...
    - permission_classes: Authenticated users can create; others
      have read-only access.
    - queryset: Retrieves all Like instances.

    Methods:
    - perform_create: Sets the owner field to the authenticated user
      when creating a like.
    """
...
class LikeDetail(generics.RetrieveUpdateDestroyAPIView):
    ...
    - permission_classes: Ensures only the like owner can edit or delete;
