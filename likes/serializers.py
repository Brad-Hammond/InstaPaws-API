...
class LikeSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        """
        Handles IntegrityError to prevent a user from liking the same post multiple times.
        Raises a ValidationError with a descriptive message if duplication occurs.
        """
        try:
